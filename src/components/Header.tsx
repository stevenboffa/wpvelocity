          ...
          <div className="flex-1 overflow-y-auto py-8 px-6">
            ...
            >
              <Link
                ...
                className="block"
              >
                <Button className="w-full bg-primary hover:bg-primary/90 text-black text-lg px-8 py-6 transform transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] glass-morphism animate-pulse">
                  Get Started
                </Button>
              </Link>
            </div>
